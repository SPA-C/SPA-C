...
# -*- coding: utf-8 -*-
"""
SPA-C dataset main method for working with datasets
...
class dataset():
    ...
    def __init__(self, path, image_size = 10, bin_size = 5000, skip_dataset=False, skip_whole=True, skip_check=False):
        """
        Dataset class for handling SPA-C datasets with ease.
        ...
        self.version = "5.7"
        print(f"SPA-C dataset v{self.version}\n")
    ...
    def fullCheck(self):
        ...
        with open(os.path.join(self.dir, "fullCheck.logs"), "a") as file :
            file.write(f"[SPA-CDataset]\tfullCheck logs\t{time.asctime()}\n")
    ...
    def save(self, savedir):
        with h5py.File(savedir, "w") as out:
            ...
            out.attrs["Edit"] = f"Modified with SPA-CDataset v{self.version}"
